...
class Landing_page extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['info_'] 		= $this->info_model->get_data_limit('info');
		$data['harga_'] 	= $this->harga_model->tampil_data('harga')->result();
		$data['kontak_'] 	= $this->kontak_model->tampil_data('kontak')->result();
		$data['carosel_'] 	= $this->carosel_model->tampil('carosel');
		$this->load->view('header_nasabah');
		$this->load->view('landing_page_coba', $data);
